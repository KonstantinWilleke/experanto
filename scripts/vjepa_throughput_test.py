...
OUTPUT_PATH = "/home/vedang/work/experanto/benchmarks/throughput_benchmark_vjepa.png"
...
def run_benchmark(root: str, num_workers: int) -> float | None:
    ...
    try:
        ...
        print(output)
        match = re.search(r'Average throughput: ([\d.]+)k', output)
...
def main():
        ...
        for num_workers in NUM_WORKERS_LIST:
            ...
            if throughputs:
                ...
                results.append({
                    ...
                    'throughput_fps': mean_throughput*1000,
                    'stderr': stderr,
    ...
    ax.set_ylabel('Throughput (Tokens/second)', fontsize=12, fontweight='bold') #HACK
    ax.set_title(
